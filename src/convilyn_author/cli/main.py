...
def template_list(query: str | None) -> None:
    ...
    from convilyn_author._internal.templates import TemplateError, list_templates
...
def template_install(name: str) -> None:
    ...
    from convilyn_author._internal.templates import TemplateError, install_template
...
def template_fork(name: str, new_name: str) -> None:
    ...
    from convilyn_author._internal.templates import TemplateError, fork_template
