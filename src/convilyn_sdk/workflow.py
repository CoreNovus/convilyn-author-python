...
if TYPE_CHECKING:
    ...
    from convilyn_sdk._internal.policy_protocol import PolicyProtocol
...
class WorkflowSpec:
    ...
    def with_multi_role(
        ...
        *,
        ...
        :class:`~convilyn_sdk.agent_role.AgentRole` Protocol (anything
    ...
    def with_policy(self, *policies: PolicyProtocol) -> WorkflowSpec:
        ...
        five built-in knobs (:class:`~convilyn_sdk.policies.RetryPolicy`,
        :class:`~convilyn_sdk.policies.TimeoutPolicy`, etc.) all conform.
        ...
        """
        from convilyn_sdk._internal.policy_translator import apply_policies
    ...
    def with_task_policy(
        ...
        *,
        ...
        :class:`~convilyn_sdk.policies.FallbackPolicy` knob.
        """
        clone = self._clone()
